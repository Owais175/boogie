...
<body>
    ...
    <style>
        ...
        .main-certificate {
            background-image: url("{{ asset('images/tpc.png') }}");
                    ...
                    <div class="main-certificate">
                        <div class="certificate-holder">
                            ...
                            <div class="para-bottom">
                                <p>This continuing education course is approved by the International Board of Specialty Certification (IBSC) and certified by Goat-Trail Austere Medical Solutions (GAMS) through the Tactical Austere Medical Practitioner (TAMP) Course.  </p>
                                <p>It provides 16 hours of continuing education toward the Tactical Paramedic Certification.</p>
                            </div>
                        </div>
                    </div>
                </div>

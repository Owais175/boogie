<div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            <li class="nav-item">
                <a href="javascript:;"><i class="la la-home"></i><span class="menu-title"
                ...
                <ul class="menu-content">
                    ...
                    <!-- <li
                        class="{{ request()->is('user_management/user_management') || request()->is('user_management/user_management*') ? 'active' : '' }}">
            ...
            <li class="nav-item">
                <a href="javascript:;"><i class="la la-share-alt"></i><span class="menu-title"
                        data-i18n="Dashboard">Inquires</span></a>
                <ul class="menu-content">
                    <li
                        class="{{ request()->is('admin/contact/inquiries') || request()->is('admin/contact/inquiries/*') ? 'active' : '' }}">
            ...
            <li class="nav-item">
                <a href="javascript:;"><i class="la la-list"></i><span class="menu-title"
                        data-i18n="Dashboard">CMS</span></a>
                <ul class="menu-content">
            ...
            <!-- <li class="nav-item">
                ...
                <ul class="menu-content">
                    ...
                    <li
                        class="{{ request()->is('subcategory/subcategory') || request()->is('subcategory/subcategory/*') ? 'active' : '' }}">
            ...
            <li class="{{ request()->is('logo/logo') || request()->is('logo/logo/*') ? 'active' : '' }}">
                <a class="menu-item" href="{{ url('logo/logo') }}"><i class="la la-shopping-cart"></i>
                    ...
                    <span data-i18n="eCommerce">Logo</span>
                </a>
            </li>
